  ...
  return (
    <>
      ...
      <div className="mx-16">
              ...
              {payload.map((item, index) =>
                index % 2 === 0 ? (
                  <div id="prompt" className={`flex justify-end mr-5 ml-20`}>
                    <div
                      className={`my-5 bg-gray-100 py-3 px-4 rounded-t-3xl rounded-bl-3xl relative`}
                    >
                  ...
                  <div id="answer" className="relative mr-20">
                    <div className="ml-5 mb-2">
                      <p className="text-gray-500 mb-4 font-medium pb-8 text-justify">
                        {item.line}
                      </p>
                    </div>
                  </div>
        ...
        {loading ? (
          <div className="flex justify-start mb-72 ml-5 mr-20 pb-44">
            <LoadingIcon className="w-6 pb-8" />
          </div>
        ) : (
          <></>
        )}
      ...
      <div className="flex justify-center fixed bottom-0 pb-3 w-full bg-gradient-to-b from-transparent via-white to-white">
        <form
          ...
          className="bg-white w-11/12 mb-3 mt-16 mx-5 justify-center flex items-center py-1 shadow-lg border-2 border-gray-200 rounded-3xl"
        >
          ...
          <input
            ...
            className={`flex-grow w-9/12 ${
              formData.prompt ? "text-gray-700" : ""
            } outline-none font-semibold py-2`}
            placeholder="Type here ..."
          />
          <div className="w-1/6 flex justify-center">
            <button
              className="px-5 py-2 rounded-full bg-blue-600 hover:bg-blue-700 text-white font-medium"
              type="submit"
            >
              Submit
            </button>
